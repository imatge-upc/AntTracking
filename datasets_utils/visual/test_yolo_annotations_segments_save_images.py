...
DOCTEXT = f"""
Usage:
  test_yolo_annotations_segments_save_images.py <dataset_yaml_path> <img_path> [--colors=<cjp>] [--save_folder=<sf>] [--save_folder2=<sf2>]

Options:
  <dataset_yaml_path>       Path to the dataset YAML file.
  <img_path>                Path to the images folder.
  --colors=<cjp>            Path to the JSON file containing colors [default: {os.path.expanduser('~/ANTS/src8_tracking/wp2_visualization/100_colors.json]')}.
  --save_folder=<sf>        Folder to save first set of images [default: ./what_yolo_see].
  --save_folder2=<sf2>      Folder to save second set of images [default: ./what_yolo_have].
"""
