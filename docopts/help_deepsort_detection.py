...
DOCTEXT = f"""  
Use background substraction to detect ants in a video and use a Transformer to define its apparence
  
Usage:
  deepsort_detection.py <inputVideo> <detectionFile> [--subsAlg=<sa>] [--varThreshold=<vt>] [--filterFG=<ff>] [--writeImages=<wi>] [--outputDir=<od>] [--minSize=<ms>] [--startWriteFrames=<sw>] [--stopFrame=<sf>]
  deepsort_detection.py -h | --help
