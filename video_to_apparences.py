...
if __name__ == "__main__":
    ...
    for i, (video_path, seq_path) in enumerate(zip(video_pathes, seq_pathes)):
        ...
        seen_ids = process_video(seen_ids, video_path, seq_path, sampling_rate, test_frac, query_frac, query_prob, reshape, do_pad_reshape, imgsz, train_dir, query_dir, test_dir, verbose=True)
